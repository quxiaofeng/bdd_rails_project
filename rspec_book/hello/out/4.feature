...
Feature: greeter says hello
  ...
  Scenario: greeter says hello          # features/greeter_says_hello.feature:7
    Given a greeter                     # features/step_definitions/greeter_steps.rb:9
      uninitialized constant CucumberGreeter (NameError)
      ./features/step_definitions/greeter_steps.rb:10:in `/^a greeter$/'
      features/greeter_says_hello.feature:8:in `Given a greeter'
    When I send it the greet message    # features/step_definitions/greeter_steps.rb:13
    Then I should see "Hello Cucumber!" # features/step_definitions/greeter_steps.rb:17
